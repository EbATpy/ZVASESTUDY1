...
*                          ).
    ...
    IF abap_true = abap_true. "activiert
      ...
      INSERT zcs1_custorders FROM TABLE @( VALUE #(
        ...
        ( client = '100' orderid = '000010' customerid = '000020' order_date = '20260429' order_total = '7100.00' discount = '3.00' status = 'BO' ) " war 000008
        " Adomeit Herbert 000005
        ( client = '100' orderid = '000011' customerid = '000022' order_date = '20260429' order_total = '1500.00' discount = '1.00'  status = 'BN' ) " war 000009
        ( client = '100' orderid = '000012' customerid = '000022' order_date = '20260429' order_total = '2300.00' discount = '2.00'  status = 'BA' ) " war 000010
        " Ahlfeld Werner 000006
        ( client = '100' orderid = '000013' customerid = '000030' order_date = '20260429' order_total = '999.00' discount = '1.00'  status = 'BA' ) " war 000011
        " Ariana Automo... 000007
        ( client = '100' orderid = '000014' customerid = '000033' order_date = '20260429' order_total = '4500.00' discount = '2.00'  status = 'BO' ) " war 000012
        ( client = '100' orderid = '000015' customerid = '000033' order_date = '20260429' order_total = '1200.00' discount = '1.00'  status = 'BA' ) " war 000013
        " Autohaus Albert... 000008
        ( client = '100' orderid = '000016' customerid = '000035' order_date = '20260429' order_total = '6200.00' discount = '3.00'  status = 'BA' ) " war 000014
        " Autohaus Bargt... 000009
        ( client = '100' orderid = '000017' customerid = '000036' order_date = '20260429' order_total = '3100.00' discount = '1.00'  status = 'BA' ) " war 000015
        " Autohaus Barm... 000010
        ( client = '100' orderid = '000018' customerid = '000047' order_date = '20260429' order_total = '8000.00' discount = '4.00'  status = 'BN' ) " war 000016
        " Autohaus Bergst... 000011
        ( client = '100' orderid = '000019' customerid = '000064' order_date = '20260429' order_total = '1750.00' discount = '1.00'  status = 'BO' ) " war 000017
        " Autohaus Bergst... 000012
        ( client = '100' orderid = '000020' customerid = '000090' order_date = '20260429' order_total = '5000.00' discount = '2.00'  status = 'BN' ) " war 000018
